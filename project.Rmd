...
The second question we chose to look at was how the number of songs per album differs for the top artists within each genre. The left plot analyzes the number of songs per album over time and the right plot looks at how the amount of songs per album differs based on the artists popularity score out of 100.
...
renderPlot({
    ggplot(genre2, aes(x = album_release_year, y = .data[[input$y5]])) +
    geom_point()
  })
```

reactive then render plot, look through sample projects
